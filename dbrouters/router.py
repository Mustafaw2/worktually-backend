class MyDatabaseRouter:
    def db_for_read(self, model, **hints):
        ...
        if model._meta.app_label == 'employee':
            return 'default'
        if model._meta.app_label == 'job_seekers':
            return 'global'
        return None
    ...
    def allow_relation(self, obj1, obj2, **hints):
        if obj1._meta.app_label in ['auth', 'admin', 'sessions', 'contenttypes'] or \
        ...
        if obj1._meta.app_label == 'employee' and obj2._meta.app_label == 'employee':
            return True
        if obj1._meta.app_label == 'job_seekers' and obj2._meta.app_label == 'job_seekers':
            return True
        return False
