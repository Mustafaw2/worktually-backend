    ...
    def get(self, request):
        ...
        try:
            ...
            if response.status_code != 200:
                return Response({'error': 'Unable to fetch candidates.'}, status=status.HTTP_400_BAD_REQUEST)
            ...
            return Response({'message': 'Success', 'data': candidates}, status=status.HTTP_200_OK)
