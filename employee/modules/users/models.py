...
class Employee(AbstractBaseUser):
    ...
    marital_status = models.CharField(max_length=20, blank=False, null=False, default='unmarried')
    ...
    social_insurance_number = models.CharField(max_length=50, blank=True, null=True, default='')
    ...
    role = models.ForeignKey('Role', on_delete=models.SmallIntegerField, null=True, blank=False, related_name='users')
    source_of_hiring = models.CharField(max_length=100, blank=True, null=True, default='')
