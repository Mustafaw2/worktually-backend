...
class AddEducationView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={201: openapi.Response("Education added successfully", EducationSerializer)},
        examples={
            'application/json': {
                "employee": 35,
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response({"message": "Education added successfully", "data": serializer.data}, status=status.HTTP_201_CREATED)
...
class EditEducationView(APIView):
    ...
    @swagger_auto_schema(
        ...
        request_body=EducationSerializer,
        responses={
            200: openapi.Response("Education updated successfully", EducationSerializer),
    ...
    def put(self, request, pk, *args, **kwargs):
        ...
        if serializer.is_valid():
            serializer.save()
            return Response({"message": "Education updated successfully", "data": serializer.data})
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
...
class AddExperienceView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={201: openapi.Response("Experience added successfully", ExperienceSerializer)},
        examples={
            'application/json': {
                "employee_id":int,
                "job_title": "HR Head",
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            serializer.save(employee_id=request.data.get('employee_id'))
            return Response({"message": "Experience added successfully", "data": serializer.data}, status=status.HTTP_201_CREATED)
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
...
class EditExperienceView(APIView):
    ...
    @swagger_auto_schema(
        ...
        request_body=ExperienceSerializer,
        responses={
            200: openapi.Response("Experience updated successfully", ExperienceSerializer),
