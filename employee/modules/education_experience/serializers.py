...
class ExperienceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Experience
        fields = ['employee_id', 'job_title', 'company_name', 'job_type', 'start_date', 'end_date', 'description', 'experience_letter']
    ...
    def create(self, validated_data):
        ...
        experience = Experience.objects.create(employee_id=employee_id, **validated_data)
        return experience