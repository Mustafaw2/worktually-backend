...
class DependentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Dependent
        fields = ['employee_id', 'name', 'relation', 'id_number', 'social_insurance_number']
    ...
    def update(self, instance, validated_data):
        ...
        instance.social_insurance_number = validated_data.get('social_insurance_number', instance.social_insurance_number)
        instance.save()
        return instance
