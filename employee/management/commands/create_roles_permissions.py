...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        # Create Permissions
        employees_list = Permission.objects.create(permission_group=employees_group, name="Employees-List")
        employees_view = Permission.objects.create(permission_group=employees_group, name="Employees-view")
        employees_edit = Permission.objects.create(permission_group=employees_group, name="Employees-edit")
        employees_delete = Permission.objects.create(permission_group=employees_group, name="Employees-delete")

        roles_list = Permission.objects.create(permission_group=roles_group, name="Roles-List")
        roles_view = Permission.objects.create(permission_group=roles_group, name="Roles-view")
        roles_create = Permission.objects.create(permission_group=roles_group, name="Roles-create")
        roles_edit = Permission.objects.create(permission_group=roles_group, name="Roles-edit")
        roles_delete = Permission.objects.create(permission_group=roles_group, name="Roles-delete")
        ...
        admin_user.profile.role = None  # Assuming admin has no specific role in your system
