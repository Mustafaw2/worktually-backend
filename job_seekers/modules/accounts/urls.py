...
urlpatterns = [
    ...
    path("jobseeker/forget-password/", ForgetPasswordView.as_view(), name="forget_password"),
    path("jobseeker/verify-otp/", VerifyOTPView.as_view(), name="verify_otp"),
    path("jobseeker/reset-password/", ResetPasswordView.as_view(), name="reset_password"),
]
